...
class HIRNNLayer(Layer):
    ...
    def step_do(self, step_in, states):
        ...
        [_GD, _GWL1] = self.GD_calculation(GW1, self.RecK, self.LG)
        _dGW = _RECnew - _GD
    ...
    def call(self, inputs):
        ...
        [GD, GWL1] = self.GD_calculation(GW1, self.RecK, self.LG)
